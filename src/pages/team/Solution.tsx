        ...
        <>
            ...
            <section className="my-5 py-6 position-relative">
                <Container>
                    <Row data-aos="fade-up" data-aos-duration="1500">
                        <Col className="text-center">
                            <h1 className="display-3 fw-semibold">Partner With Us</h1>
                            <p className="mx-auto">
                                By partnering with us, you’ll have access to the full range of Akinon platform, as well
                                as the support of our knowledgeable and experienced team. We’ll work with you to
                                understand your specific needs and help you find the right solution to drive growth and
